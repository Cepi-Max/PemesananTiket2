...
class DashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        $totalPendapatan = PesanTiket::where('status', 'Sudah Dibayar')
        ...
        $penjualanPerMaskapai = DB::table('penerbangan')
        ->join('pesawat', 'penerbangan.id_pesawat', '=', 'pesawat.id')
        ->join('maskapai', 'pesawat.id_maskapai', '=', 'maskapai.id')
        ...
        ->select('maskapai.nama_maskapai', DB::raw('COUNT(detail_penumpang.id) as total_penumpang'))
        ->groupBy('maskapai.nama_maskapai')
        ->get();
        ...
        $data = [
            ...
            'penjualanPerMaskapai' => $penjualanPerMaskapai,
        ];
