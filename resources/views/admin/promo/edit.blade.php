...
<div class="container mt-4">
    ...
    <form action="{{ route('admin.promo.update', $promo->slug) }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="number" id="jumlah_persen" name="jumlah_persen" min="0" max="100" step="0.01"
                class="form-control"
                value="{{ old('jumlah_persen', $promo->jumlah_persen) }}">
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="number" id="jumlah_kupon" name="jumlah_kupon" min="0" step="0.01"
                class="form-control"
                value="{{ old('jumlah_kupon', $promo->jumlah_kupon) }}">
        </div>
