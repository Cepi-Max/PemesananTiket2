...
Route::get('/user/chart-maskapai', [UserPemesananController::class, 'chartPerMaskapai'])->name('user.chart.maskapai');
...
Route::post('/promo/store', [PromoController::class, 'store'])->name('prosespromo');
...
//bandara
Route::get('/bandara/autocomplete', [BandaraController::class, 'autocomplete'])->name('bandara.autocomplete');
...
Route::middleware('auth')->group(function () {
    ...
    // admin payment
    // Route untuk daftar pembayaran admin
Route::get('/admin/payments', [AdminPaymentController::class, 'index'])->name('admin.bayar');

// Route untuk melihat detail pembayaran
Route::get('/admin/payments/{payment}', [AdminPaymentController::class, 'show'])->name('admin.payment.show');

// Route untuk mengubah status pembayaran (approved/rejected)
Route::put('/admin/payments/{payment}', [AdminPaymentController::class, 'update'])->name('admin.payment.update');
    ...
    // Form Pembayaran dan proses penyimpanan pembayaran
Route::get('/payment/{pesanTiketId}', [PaymentController::class, 'showForm'])->name('payment.form');
Route::post('/payment/{pesanTiketId}', [PaymentController::class, 'store'])->name('payment.store');

// Halaman status pembayaran pengguna
Route::get('/payment/status/{orderId}', [PaymentController::class, 'status'])->name('payment.status');

Route::post('/payment/upload', [PaymentController::class, 'upload'])->name('payment.upload');
// Admin: Daftar pembayaran yang perlu dikonfirmasi
